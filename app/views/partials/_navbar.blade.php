			...
			<div class="collapse navbar-collapse" id="custom-navbar">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<ul class="dropdown-menu" role="menu" aria-labelledby="profile-dropdown">
						...
						<li role="presentation"><a href="{{URL::to('message')}}" role="menuitem" tabindex="-1">Messages <span class="badge"></span></a></li>
						<li role="presentation"><a href="{{URL::route('feedback')}}" role="menuitem" tabindex="-1">Feedback</a></li>
